...
function WBHAFF()
    local Me = game:GetService("Workspace").UserData["User_" .. game.Players.LocalPlayer.UserId]
    Fruit1 = Me.Data.DevilFruit.Value
    Fruit2 = Me.Data.DevilFruit2.Value
    Melee1 = Me.Data.DFT1Melee.Value
    Sniper1 = Me.Data.DFT1Sniper.Value
    Sword1 = Me.Data.DFT1Sword.Value
    Defense1 = Me.Data.DFT1Defense.Value
    Melee2 = Me.Data.DFT2Melee.Value
    Sniper2 = Me.Data.DFT2Sniper.Value
    Sword2 = Me.Data.DFT2Sword.Value
    Defense2 = Me.Data.DFT2Defense.Value
    local My_Request = (syn and syn.request) or (http and http.request) or request;
            ...
            ["embeds"] = {
                {
                    ...
                    ["fields"] = {
                        ...
                        {
                            ["name"] = "**First Devil Fruit And Aff Melee | Sniper | Sword | Defense**",
                            ["value"] = Fruit1 .. " | " .. Melee1  .. " | " .. Sniper1 .. " | " .. Sword1 .. " | " .. Defense1 ,
                            ["inline"] = true
                        },
                        {
                            ["name"] = "**Second Devil Fruit And Aff Melee | Sniper | Sword | Defense**",
                            ["value"] = Fruit2 .. " | " .. Melee2  .. " | " .. Sniper2 .. " | " .. Sword2 .. " | " .. Defense2 ,
                            ["inline"] = true
                        }                          
                    }
                }
